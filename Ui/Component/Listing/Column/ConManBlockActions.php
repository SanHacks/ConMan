...
namespace SageBytez\ConMan\Ui\Component\Listing\Column;
 ...
 */
class ConManBlockActions extends Column
{
    /**
     * Entity name.
     */
    protected const ENTITY_NAME = 'ConMan';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH = 'con_man/conman/edit';
    private const DELETE_URL_PATH = 'con_man/conman/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[ConManInterface::CON_MAN_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [ConManInterface::CON_MAN_ID => $item[ConManInterface::CON_MAN_ID]];
